                        ...
                        <div className="space-y-3">
                            {results.map((team) => (
                                <div key={team._id} className="p-4 rounded-2xl border mb-4 transition-all"
                                    ...
                                    {/* Leader */}
                                    <div className="flex items-center gap-3 p-3 rounded-xl mb-2" style={{ background: "rgba(0, 0, 0, 0.3)", border: "1px solid rgba(255,255,255,0.05)" }}>
                                    ...
                                    {team.members.map((member: any, idx: number) => (
                                        <div key={idx} className="flex items-center gap-3 p-3 rounded-xl mb-1" style={{ background: "rgba(0, 0, 0, 0.2)", border: "1px solid rgba(255,255,255,0.03)" }}>
                                            <div className="flex-1 min-w-0">
                        ...
                        {recentCheckins.length === 0 ? (
                            ...
                            <div className="space-y-2 max-h-[60vh] overflow-y-auto">
                                {recentCheckins.map((checkin, idx) => (
                                    <div key={idx} className="p-3 rounded-xl animate-fade-in border border-white/5" style={{ background: "rgba(0, 0, 0, 0.2)" }}>
